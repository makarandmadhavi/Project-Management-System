...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2020 at 02:14 PM
...
(319, 'Mrs.  Bharne Smita D', 'COMPUTER SCIENCE', '8888075747', 'bharne.smita@gmail.com', 'Prof.', 'ML/AI', 1),
...
(800, 'Dr. Ragha Leena R.', 'COMPUTER SCIENCE', '9096967040', 'dr.leena.ragha@gmail.com', 'ADHOC PROFESSOR', 'ML/AI', 0),
...
(1, 'f_1', 'Adarsh Pednekar', 'Rohan Behera', 'Shubham Karkar'),
(6, 'f_3', 'Nikhil Ingale', 'Makarand Madhavi', 'Piyush Jha'),
(7, 's_4', 'ABHISHEK TIWARI', 'AMAN GUPTA', 'AMIT SAXENA'),
(8, 'f_4', 'ANKIT ANAND', 'ANURAG DASH', 'ARPIT SRIVASTAVA');
...
(48, 'f_1', 'NIKmak5@', 'student', 1, 'COMPUTER SCIENCE'),
(53, 'f_3', 'NIKmak5@', 'student', 1, 'COMPUTER SCIENCE'),
(54, 's_4', 'NIKmak5@', 'student', 1, 'COMPUTER SCIENCE'),
(55, 'f_4', 'NIKmak5@', 'student', 1, 'COMPUTER SCIENCE');
...
(3, 'f_1', 'Snake Robot', 'Internet OF Things', 'Nowadays robotics has grown beyond leaps in almost all every aspect of life and the most important fields are rescue search and medical field. Every year a number of people are losing their life because of natural calamities such as earthquakes and mine accidents. Often, many are trapped in the. Our idea is to provide a robot which can easily penetrate through the small gaps in debris and to track the people trapped inside and rescue them. \r\n\r\nSerpentine resembles the motion of the snake and is highly flexible to navigate through the available path in the debris. Basically, our serpentine has two modes of operation: In the first mode, it moves autonomously like a snake. This has been achieved through software. In the second mode, it just moves according to our instructions and this is handled via remote control. In each mode, a camera on the head of serpentine continuously provides the visual information to outside world through which we can track the trapped people and rescue them.', '5f34e6173d4bdran2018.pdf', '5f34e6173d4d4ran2018.pdf', '5f34e6173d4dbran2018.pdf', '', 'approved', 'Mrs.  Bharne Smita D', 'good project'),
(5, 'f_3', 'Snake Robot', 'Machine Learning', 'snake', '5f35175c66cc3ran2018.pdf', '5f35175c66cd1ran2018.pdf', '5f35175c66cd6ran2018.pdf', '', 'rejected', 'Mrs. Gaikwad Snehal P. ', 'change the topic'),
(6, 's_4', 'cataract detection', 'image processing', 'testing...........', '5f35270495fderan2018.pdf', '5f35270495ff7ran2018.pdf', '5f35270495fferan2018.pdf', '', 'pending', '', ''),
(7, 'f_4', 'Snake Robot', 'Machine Learning', 'testing.....', '5f352b16e44ceran2018.pdf', '5f352b16e44dfran2018.pdf', '5f352b16e44e4ran2018.pdf', '5f352b16e44e9ran2018.pdf', 'approved', 'Mrs.  Bharne Smita D', 'good');
...
(21, 'Adarsh Pednekar', '17IT3021', 'piyushjha65@gmail.com', 'COMPUTER SCIENCE', 'TE', 'A', 'A3', 7977064752, 1, 1),
(22, 'Rohan Behera', '17IT3022', 'nikhil.ingale99@gmail.com', 'COMPUTER SCIENCE', 'TE', 'A', 'A3', 1234567891, 2, 1),
(23, 'Shubham Karkar', '17IT3023', 'jha.piyush.17it1027@gmail.com', 'COMPUTER SCIENCE', 'TE', 'A', 'A4', 1987654321, 1, 1),
(24, 'SUNIL KUMAR MEENA', '17IT3024', 'piyushjha65@gmail.com', 'COMPUTER SCIENCE', 'TE', 'A', 'A3', 7977064752, 1, 1),
(25, 'AADITYA BHARAT KUMAR', '17IT3025', 'nikhil.ingale99@gmail.com', 'COMPUTER SCIENCE', 'TE', 'A', 'A2', 1234567891, 1, 1),
(26, 'ABHISHEK ANAND', '17IT3026', 'jha.piyush.17it1027@gmail.com', 'COMPUTER SCIENCE', 'TE', 'A', 'A1', 1987654321, 1, 1),
(27, 'ABHISHEK TIWARI', '17IT3027', 'piyushjha65@gmail.com', 'COMPUTER SCIENCE', 'TE', 'A', 'A3', 5432167891, 2, 1),
(28, 'AMAN GUPTA', '17IT3028', 'nikhil.ingale99@gmail.com', 'COMPUTER SCIENCE', 'TE', 'A', 'A1', 6789012345, 2, 1),
(29, 'AMIT SAXENA', '17IT3029', 'jha.piyush.17it1027@gmail.com', 'COMPUTER SCIENCE', 'TE', 'A', 'A3', 1234567890, 1, 1),
(30, 'ANKIT ANAND', '17IT3030', 'piyushjha65@gmail.com', 'COMPUTER SCIENCE', 'TE', 'A', 'A4', 1223456789, 2, 1),
(31, 'ANURAG DASH', '17IT3031', 'nikhil.ingale99@gmail.com', 'COMPUTER SCIENCE', 'TE', 'A', 'A2', 2345617890, 1, 1),
(32, 'ARPIT SRIVASTAVA', '17IT3032', 'jha.piyush.17it1027@gmail.com', 'COMPUTER SCIENCE', 'TE', 'A', 'A1', 7890123456, 1, 1),
